// zhaozhensen@wind-mobi.com 20160128 begin
...
#define VOL_1000 1000000
	...
	if (On) {
		...
		//ranyanhao@wind-mobi.com 20160220 begin
			ISP_MCLK1_EN(1);
		//ranyanhao@wind-mobi.com 20160220 end
#endif
		...
		//ranyanhao@wind-mobi.com 20160127 begin
			else if ((pinSetIdx == 0 ) && currSensorName && 
			(0 == strcmp(currSensorName, SENSOR_DRVNAME_S5K3L8_MIPI_RAW))) {
			PK_DBG("kdCISModulePowerOn get in---  SENSOR_DRVNAME_S5K3L8_MIPI_RAW \n");
			//First Power Pin low and Reset Pin Low
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
	     ...
	     //AF_VCC
			...
			(0 == strcmp(currSensorName, SENSOR_DRVNAME_S5K3M2_MIPI_RAW))) {
			...
			(0 == strcmp(currSensorName, SENSOR_DRVNAME_S5K3L8_MIPI_RAW_NEW))) {
			PK_DBG("kdCISModulePowerOn get in---  SENSOR_DRVNAME_S5K3L8_MIPI_RAW_NEW \n");
			//First Power Pin low and Reset Pin Low
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
		...
		//ranyanhao@wind-mobi.com 20160127 end
		//ranyanhao@wind-mobi.com 20160216 begin
		else if ((pinSetIdx == 1 ) && currSensorName &&
		(0 == strcmp(currSensorName, SENSOR_DRVNAME_HI551_MIPI_RAW))) {
			PK_DBG("kdCISModulePowerOn get in---  SENSOR_DRVNAME_HI551_MIPI_RAW \n");
			//First Power Pin low and Reset Pin Low
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
		...
		// zhaozhensen@wind-mobi.com 20160628 begin
		else if ((pinSetIdx == 1 ) && currSensorName &&
		(0 == strcmp(currSensorName, SENSOR_DRVNAME_HI553_MIPI_RAW))) {
			PK_DBG("lihaiyan kdCISModulePowerOn get in---  SENSOR_DRVNAME_HI553_MIPI_RAW \n");
			//First Power Pin low and Reset Pin Low
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
            ...
            if(TRUE != _hwPowerOn(VCAMIO, VOL_1800))
            {
                PK_DBG("[CAMERA SENSOR] lihaiyan Fail to enable digital power (VCAM_IO), power id = %d \n", VCAMIO);
                goto _kdCISModulePowerOn_exit_;
            }
            ...
            if(TRUE != _hwPowerOn(VCAMA, VOL_2800))
            {
                PK_DBG("[CAMERA SENSOR] lihaiyan Fail to enable analog power (VCAM_A), power id = %d\n", VCAMA);
                goto _kdCISModulePowerOn_exit_;
            }
            ...
            if(TRUE != _hwPowerOn(VCAMD, VOL_1200))
            {
                 PK_DBG("[CAMERA SENSOR] lihaiyan Fail to enable digital power (VCAM_D), power id = %d \n", VCAMD);
                 goto _kdCISModulePowerOn_exit_;
            }
            ...
            if(TRUE != _hwPowerOn(VCAMAF, VOL_2800))
            {
                PK_DBG("[CAMERA SENSOR] lihaiyan Fail to enable analog power (VCAM_AF), power id = %d \n", VCAMAF);
                goto _kdCISModulePowerOn_exit_;
            }
            ...
            //mdelay(20);
			PK_DBG("[CAMERA SENSOR] lihaiyan success to enable HI553 power \n");
        }
		// zhaozhensen@wind-mobi.com 20160628 end
		// zhaozhensen@wind-mobi.com 20160127 begin
		 else if ((pinSetIdx == 1 ) && currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName))) 
        {
			PK_DBG("[PowerON] get in pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);
		...
		// zhaozhensen@wind-mobi.com 20160127 end
		
		//zhaozhensen@wind-mobi.com 20160216 begin
		 else if ((pinSetIdx == 0 ) && currSensorName && (0 == strcmp(SENSOR_DRVNAME_IMX258_MIPI_RAW, currSensorName))) 
        {
			PK_DBG("kdCISModulePowerOn get in---  SENSOR_DRVNAME_IMX258_MIPI_RAW \n");
			//First Power Pin low and Reset Pin Low
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
		...
		//zhaozhensen@wind-mobi.com 20160215 end
		
		// zhaozhensen@wind-mobi.com 20160720 begin
		else if ((pinSetIdx == 1 ) && currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K5E8YX_MIPI_RAW, currSensorName))) 
        {
			PK_DBG("kdCISModulePowerOn get in---  SENSOR_DRVNAME_S5K5E8YX_MIPI_RAW \n");
	        ...
	        if(TRUE != _hwPowerOn(VCAMA, VOL_2800))
            {
                PK_DBG("[CAMERA SENSOR] zhaozhensen Fail to enable analog power (VCAM_A), power id = %d\n", VCAMA);
                goto _kdCISModulePowerOn_exit_;
            }
		   ...
		   //VCAM_IO
            if(TRUE != _hwPowerOn(VCAMIO, VOL_1800))
            {
                PK_DBG("[CAMERA SENSOR] zhaozhensen Fail to enable digital power (VCAM_IO), power id = %d \n", VCAMIO);
                goto _kdCISModulePowerOn_exit_;
            }
            ...
            if(TRUE != _hwPowerOn(VCAMD, VOL_1200))
            {
                 PK_DBG("[CAMERA SENSOR] zhaozhensen Fail to enable digital power (VCAM_D), power id = %d \n", VCAMD);
                 goto _kdCISModulePowerOn_exit_;
            }
            ...
            //mdelay(20);
			PK_DBG("[CAMERA SENSOR] zhaozhensen success to enable S5K5E8YX power \n");

        }
		// zhaozhensen@wind-mobi.com 20160720 end
		//liulinsheng@wind-mobi.com 20160307 begin
		 else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV13853_MIPI_RAW, currSensorName))) 
        {
			printk("11 func==%s line=%d\n", __func__, __LINE__);
			PK_DBG("kdCISModulePowerOn get in---  SENSOR_DRVNAME_OV13853_MIPI_RAW \n");
			//First Power Pin low and Reset Pin Low
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
		...
		//ranyanhao@wind-mobi.com 20160127 begin
			...
			(0 == strcmp(currSensorName,SENSOR_DRVNAME_S5K3L8_MIPI_RAW))) {
			PK_DBG("[PowerOFF] get in---  SENSOR_DRVNAME_S5K3L8_MIPI_RAW \n");
            //Set Power Pin low and Reset Pin Low
			...
			(0 == strcmp(currSensorName,SENSOR_DRVNAME_S5K3M2_MIPI_RAW))) {
			PK_DBG("[PowerOFF] get in---  SENSOR_DRVNAME_S5K3M2_MIPI_RAW \n");
            //Set Power Pin low and Reset Pin Low
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
			...
			(0 == strcmp(currSensorName,SENSOR_DRVNAME_S5K3L8_MIPI_RAW_NEW))) {
			PK_DBG("[PowerOFF] get in---  SENSOR_DRVNAME_S5K3L8_MIPI_RAW_NEW \n");
            //Set Power Pin low and Reset Pin Low
		...
		(0 == strcmp(currSensorName, SENSOR_DRVNAME_HI551_MIPI_RAW))) {
			PK_DBG("[PowerOFF] get in---  SENSOR_DRVNAME_HI551_MIPI_RAW \n");
            //Set Power Pin low and Reset Pin Low
		...
		(0 == strcmp(currSensorName, SENSOR_DRVNAME_HI553_MIPI_RAW))) {
			PK_DBG("[PowerOFF] get in---  SENSOR_DRVNAME_HI553_MIPI_RAW \n");
            //Set Power Pin low and Reset Pin Low
			...
			PK_DBG("[CAMERA SENSOR] lihaiyan success to disenable HI553 power \n");
        }
		// zhaozhensen@wind-mobi.com 20160628 end
		// zhaozhensen@wind-mobi.com 20160127 begin
		else if ((pinSetIdx == 1) && currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName)))
		{
            PK_DBG("[PowerOFF] get in pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);
		...
		{
			PK_DBG("[PowerOFF] get in---  SENSOR_DRVNAME_IMX258_MIPI_RAW \n");
            //Set Power Pin low and Reset Pin Low
		...
		//zhaozhensen@wind-mobi.com 20160216 end
		
		// zhaozhensen@wind-mobi.com 20160720 begin
		else if ((pinSetIdx == 1) && currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K5E8YX_MIPI_RAW, currSensorName)))
        {
			PK_DBG("[PowerOFF] get in---  SENSOR_DRVNAME_S5K5E8YX_MIPI_RAW \n");
            //Set Power Pin low and Reset Pin Low
		...
		{
			printk("21 func==%s line=%d\n", __func__, __LINE__);
			PK_DBG("[PowerOFF] get in---  SENSOR_DRVNAME_OV13853_MIPI_RAW \n");
            //Set Power Pin low and Reset Pin Low
...
// zhaozhensen@wind-mobi.com 20160128 end