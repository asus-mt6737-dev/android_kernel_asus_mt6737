...
typedef enum{
    ...
    IMGSENSOR_MODE_CUSTOM1, //zhenglihong@wind-mobi.com 20160707 
} IMGSENSOR_MODE;
...
typedef struct imgsensor_info_struct { 
    ...
    imgsensor_mode_struct custom1;      ////zhenglihong@wind-mobi.com 20160707 
    ...
    kal_uint8  custom1_delay_frame;     //enter custom1 delay frame num //zhenglihong@wind-mobi.com 20160707 
