...
//	 {0x00,1,{0x00}},    //3lane  
//add by qiangang for change frequency begin 
	 {0x38,1,{0x01}},
	 {0x39,1,{0x00}},
//add by qiangang for change frequency end	 
	 {0x6C,1,{0x15}},
	 {0x6E,1,{0x1E }},
	 {0x6F,1,{0x25}},
	 {0x8D,1,{0x19}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	//	params->dsi.cont_clock=1;
		...
		params->dsi.vertical_sync_active				= 2; //2; 	//4  10 
		params->dsi.vertical_backporch				    = 18;  //18;  	//14 40 
		params->dsi.vertical_frontporch				    = 20;  //8;  	//16  40
		params->dsi.vertical_active_line				= FRAME_HEIGHT;     
		params->dsi.horizontal_sync_active				= 10;   //4
		params->dsi.horizontal_backporch				= 40;  //60  70
		params->dsi.horizontal_frontporch				= 50;   //60 70
...
/*********************zhangkaiyuan@wind-mobi.com 20160815 begin*********************/
	    params->dsi.esd_check_enable = 1;//0;  //1  //lihaiyan@wind-mobi.com 20160713 begin
	    params->dsi.customization_esd_check_enable      = 1;//0; //1

	    params->dsi.lcm_esd_check_table[0].cmd          = 0x0a;//0xd9;
...
*/
/*********************zhangkaiyuan@wind-mobi.com 20160815 end*********************/
}
