...
#define MA_DRV_VERSION	    (0x00004001)

#define MALOGD_LEVEL	KERN_EMERG     //[KERN_DEBUG|KERN_EMERG] usually, the debug level is used for the release version
//dingyisheng@wind-mobi.com 20161123 begin
#define MA_CHR_FILE_NAME 	"madev"  //do not neeed modify usually 
//dingyisheng@wind-mobi.com 20161123 end
...
extern unsigned int mas_get_interrupt_gpio(int index);
