...
//
//dingyisheng@wind-mobi.com 20161230 begin
#define Wind_FP_ATA
#ifdef Wind_FP_ATA
...
extern unsigned int FP_vendor;
extern char FP_version[20];
#endif

//dingyisheng@wind-mobi.com 20161230 end
...
static irqreturn_t mas_interrupt(int irq, void *dev_id) {
   // wake_lock_timeout(&gIntWakeLock, 3*HZ);
...
int mas_probe(struct spi_device *spi) {
    ...
    mas_set_input();
    MALOGF("end");
    //dingyisheng@wind-mobi.com 20170206 begin
    #ifdef CONFIG_WIND_DEVICE_INFO
	   sprintf(FP_id_str, "afs121");
          sprintf(FP_version,"1.1.21");
	   FP_vendor = 0X01;
    #endif
    //dingyisheng@wind-mobi.com 20170206 end
    return ret;
...
static int __init mas_init(void)
{
    int ret = 0;
    MALOGF("start");
   //dingyisheng@wind-mobi.com 20160705 begin
 #ifdef Wind_FP_ATA
 ...
 #endif
 //dingyisheng@wind-mobi.com 20160705 end
