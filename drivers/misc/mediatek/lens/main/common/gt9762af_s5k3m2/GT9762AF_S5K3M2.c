...
#define PLATFORM_DRIVER_NAME "lens_actuator_gt9762af_s5k3m2"
#define AF_DRIVER_CLASS_NAME "actuatordrv_gt9762af_s5k3m2"
...
static inline int getAFInfo(__user stGT9762AF_S5K3M2_MotorInfo * pstMotorInfo)
{
	stGT9762AF_S5K3M2_MotorInfo stMotorInfo;
	...
	if (copy_to_user(pstMotorInfo, &stMotorInfo, sizeof(stGT9762AF_S5K3M2_MotorInfo)))
...
#ifdef LensdrvCM3
static inline int getAFMETA(__user stGT9762AF_S5K3M2_MotorMETAInfo * pstMotorMETAInfo)
{
	stGT9762AF_S5K3M2_MotorMETAInfo stMotorMETAInfo;
	...
	if (copy_to_user(pstMotorMETAInfo, &stMotorMETAInfo, sizeof(stGT9762AF_S5K3M2_MotorMETAInfo)))
		LOG_INF("copy to user failed when getting motor information\n");
...
long GT9762AF_S5K3M2_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	...
	switch (a_u4Command) {
	case GT9762AF_S5K3M2_IOC_G_MOTORINFO:
		i4RetValue = getAFInfo((__user stGT9762AF_S5K3M2_MotorInfo *) (a_u4Param));
		break;
#ifdef LensdrvCM3
	case GT9762AF_S5K3M2_IOC_G_MOTORMETAINFO:
		i4RetValue = getAFMETA((__user stGT9762AF_S5K3M2_MotorMETAInfo *) (a_u4Param));
		break;
#endif
	case GT9762AF_S5K3M2_IOC_T_MOVETO:
		i4RetValue = moveAF(a_u4Param);
		break;

	case GT9762AF_S5K3M2_IOC_T_SETINFPOS:
		i4RetValue = setAFInf(a_u4Param);
		break;

	case GT9762AF_S5K3M2_IOC_T_SETMACROPOS:
...
static const struct file_operations g_stAF_fops = {
	.owner = THIS_MODULE,
	.open = AF_Open,
	.release = GT9762AF_S5K3M2_Release,
	.unlocked_ioctl = GT9762AF_S5K3M2_Ioctl,
#ifdef CONFIG_COMPAT
	.compat_ioctl = GT9762AF_S5K3M2_Ioctl,
#endif
};
...
static int __init GT9762AF_S5K3M2_i2C_init(void)
{
...
static void __exit GT9762AF_S5K3M2_i2C_exit(void)
{
	platform_driver_unregister(&g_stAF_Driver);
}
module_init(GT9762AF_S5K3M2_i2C_init);
module_exit(GT9762AF_S5K3M2_i2C_exit);

MODULE_DESCRIPTION("GT9762AF_S5K3M2 lens module driver");
