...
#ifndef _GT9762AF_NEW_H
#define _GT9762AF_NEW_H

#include <linux/ioctl.h>
/* #include "kd_imgsensor.h" */

#define GT9762AF_NEW_MAGIC 'A'
...
#define GT9762AF_NEW_IOC_G_MOTORINFO _IOR(GT9762AF_NEW_MAGIC, 0, stGT9762AF_NEW_MotorInfo)

#define GT9762AF_NEW_IOC_T_MOVETO _IOW(GT9762AF_NEW_MAGIC, 1, u32)

#define GT9762AF_NEW_IOC_T_SETINFPOS _IOW(GT9762AF_NEW_MAGIC, 2, u32)

#define GT9762AF_NEW_IOC_T_SETMACROPOS _IOW(GT9762AF_NEW_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define GT9762AF_NEW_IOC_G_MOTORMETAINFO _IOR(GT9762AF_NEW_MAGIC, 4, stGT9762AF_NEW_MotorMETAInfo)
#endif
