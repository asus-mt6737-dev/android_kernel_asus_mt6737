...
#define  KEY_GESTURE_UP						KEY_F17 //KEY_UP
#define  KEY_GESTURE_DOWN					KEY_DOWN
#define  KEY_GESTURE_LEFT					KEY_LEFT 
#define  KEY_GESTURE_RIGHT					KEY_RIGHT
#define  KEY_GESTURE_O						KEY_O
#define  KEY_GESTURE_E						KEY_F14 //KEY_E
#define  KEY_GESTURE_M						KEY_M 
#define  KEY_GESTURE_L						KEY_L
#define  KEY_GESTURE_W						KEY_F15 //KEY_W
#define  KEY_GESTURE_S						KEY_F18 //KEY_S 
#define  KEY_GESTURE_V						KEY_F20 //KEY_V
#define  KEY_GESTURE_C                      KEY_F13 //KEY_C
#define  KEY_GESTURE_Z						KEY_F19 //KEY_Z
...
int fts_Gesture_init(struct input_dev *input_dev)
{
	...
	input_set_capability(input_dev, EV_KEY, KEY_F21);
    ...
    __set_bit(KEY_F21, input_dev->keybit);	
...
static void fts_check_gesture(struct input_dev *input_dev,int gesture_id)
{
	...
	switch(gesture_id)
	{
	        ...
	        case GESTURE_DOUBLECLICK:
	                input_report_key(input_dev, KEY_F21, 1);
	                input_sync(input_dev);
	                input_report_key(input_dev, KEY_F21, 0);
	                input_sync(input_dev);
