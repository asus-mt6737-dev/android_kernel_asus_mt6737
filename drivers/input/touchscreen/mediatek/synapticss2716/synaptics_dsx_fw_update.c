...
//hebiao@wind-mobi.com 20160907 end
	...
	fwu->image = fw_data;
	//printk("hb func==%s line=%d config_id=%s, config_size=%d\n ",__func__, __LINE__, fwu->config_id, fwu->config_size);
...
//hebiao@wind-mobi.com 20160907 begin
	...
	fwu->rmi4_data->config_id = be_to_uint(fwu->config_id);
	printk("hb line=%d get config_id=0x%x\n", __LINE__, rmi4_data->config_id);
	sprintf(g_ctp_id_str,"%s", "synaptics_s2716");
	g_ctp_fwvr = rmi4_data->config_id;
	g_ctp_vendor = rmi4_data->firmware_id; 
#endif
//hebiao@wind-mobi.com 20160907 end
...
static int synaptics_rmi4_fwu_init(struct synaptics_rmi4_data *rmi4_data)
{
	...
	fwu->fn_ptr->read = rmi4_data->i2c_read; //f
